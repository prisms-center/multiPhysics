...
void  MatrixFreePDE<dim,degree>::computeIntegral(double& integratedField, int index, std::vector<vectorType_pf*> variableSet) {
...
template <int dim, int degree>
void MatrixFreePDE<dim,degree>::computeIntegralMF(double& integratedField, int index, const std::vector<vectorType_pf*> variableSet){
  //log time
  computing_timer_pf.enter_subsection("matrixFreePDE: computeIntegralMF");
  ...
  //end log
  computing_timer_pf.leave_subsection("matrixFreePDE: computeIntegralMF");
}
