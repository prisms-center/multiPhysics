...
void MatrixFreePDE<dim,degree>::solveIncrement(bool skip_time_dependent){
    ...
    //log time
    computing_timer_pf.enter_subsection("matrixFreePDE: solveIncrements");
    Timer time;
    char buffer[200];
    ...
    for(unsigned int fieldIndex=0; fieldIndex<fields.size(); fieldIndex++){
        ...
        if (fields[fieldIndex].pdetype==EXPLICIT_TIME_DEPENDENT && !skip_time_dependent){
            ...
            //computing_timer_pf.enter_subsection("matrixFreePDE: updateExplicitGhosts");

            solutionSet[fieldIndex]->update_ghost_values();
            //computing_timer_pf.leave_subsection("matrixFreePDE: updateExplicitGhosts");
    ...
    //log time
    computing_timer_pf.leave_subsection("matrixFreePDE: solveIncrements");
