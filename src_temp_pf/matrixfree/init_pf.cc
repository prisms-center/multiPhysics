// init_pf() method for MatrixFreePDE class
...
template <int dim, int degree>
 void MatrixFreePDE<dim,degree>::init_pf(){
	 computing_timer_pf.enter_subsection("matrixFreePDE: initialization");
     ...
     if (userInputs_pf.resume_from_checkpoint){
         load_checkpoint_triangulation_pf();
     }
     else {
	 ...
	 computing_timer_pf.leave_subsection("matrixFreePDE: initialization");
}
