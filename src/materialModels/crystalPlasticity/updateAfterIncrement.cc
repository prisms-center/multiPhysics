...
//Trapezoidal integration rule
        ...
        FirstPiolaStress[cellID][q]=P;
				...
				if (this->userInputs_cp.writeOutput){
					...
					this->postprocessValues(cellID, q, 3, 0) = energy[cellID][q][1];
					this->postprocessValues(cellID, q, 4, 0) = energy[cellID][q][2];
					this->postprocessValues(cellID, q, 5, 0) = energy[cellID][q][3];
					this->postprocessValues(cellID, q, 6, 0) = energy[cellID][q][4];
					this->postprocessValues(cellID, q, 7, 0) = energy[cellID][q][5];
					this->postprocessValues(cellID, q, 8, 0) = energy[cellID][q][6];
