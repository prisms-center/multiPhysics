...
template <int dim>
void crystalPlasticity<dim>::inactive_slip_removal(Vector<double> &active, Vector<double> &x_beta_old, Vector<double> &x_beta, unsigned int &n_PA, unsigned int &n_Tslip_systems_Region, Vector<double> &PA, Vector<double> b,FullMatrix<double> A,FullMatrix<double> &A_PA, unsigned int &n_Tslip_systems_RegionWOtwin){
    ...
    while (flag1==0){
        ...
        iter=0;
        for(unsigned int i=0;i<n_Tslip_systems_RegionWOtwin;i++){
