// Functions for userInputParameters_cp class

#include "../../include/userInputParameters_cp.h"

userInputParameters_cp::userInputParameters_cp(std::string inputfile, dealii::ParameterHandler & parameter_handler):
...
void userInputParameters_cp::declare_parameters(dealii::ParameterHandler & parameter_handler){
