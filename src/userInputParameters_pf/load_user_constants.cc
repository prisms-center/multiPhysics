#include "../../include/userInputParameters_pf.h"
...
// ==========================================================================================
template <int dim>
void userInputParameters_pf<dim>::load_user_constants(inputFileReader & input_file_reader, dealii::ParameterHandler & parameter_handler){
...
// ==========================================================================================
template <int dim>
dealii::Tensor<2,2*dim-1+dim/3> userInputParameters_pf<dim>::get_Cij_tensor(std::vector<double> elastic_constants, const std::string elastic_const_symmetry) const{
...
template <int dim>
dealii::Tensor<2, 2*dim-1+dim/3> userInputParameters_pf<dim>::getCIJMatrix(const elasticityModel model, const std::vector<double> constants, dealii::ConditionalOStream & pcout) const {
  //CIJ.fill(0.0);
...
#include "../../include/userInputParameters_pf_template_instantiations.h"
