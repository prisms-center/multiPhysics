// Methods for the userInputParameters_pf class
#include "../../include/userInputParameters_pf.h"
#include <deal.II/base/mpi.h>
#include <deal.II/base/utilities.h>

template <int dim>
userInputParameters_pf<dim>::userInputParameters_pf(inputFileReader & input_file_reader, dealii::ParameterHandler & parameter_handler, variableAttributeLoader variable_attributes){
