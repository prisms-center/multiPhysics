...
void MultiPhysicsBVP<dim,degree>::setBoundaryValues(const Point<dim>& node, const unsigned int dof, bool& flag, double& value){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::bcFunction1(double yval, double &value_x, double &value_y, double currentIncr){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::bcFunction2(double yval, double &value_x, double &value_y,double currentIncr){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::bcFunction3(double xval, double &value_x, double &value_y,double currentIncr){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::bcFunction4(double xval, double &value_x, double &value_y,double currentIncr){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::applyDirichletBCs_cp(){
