...
void MultiPhysicsBVP<dim,degree>::updateBeforeIteration(){
  //default method does nothing
}

//method called after each iteration
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::updateAfterIteration(){
  //default method does nothing
}

//method called after each iteration
template <int dim, int degree>
bool MultiPhysicsBVP<dim,degree>::testConvergenceAfterIteration(){
