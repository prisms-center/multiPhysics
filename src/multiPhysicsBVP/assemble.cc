//assemble method for multiPhysicsBVP class
#include "../../include/multiPhysicsBVP.h"

//FE assemble operation
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::assemble(){
  ...
  if(userInputs_cp.enablePeriodicBCs){
    ...
    if (userInputs_cp.enableNeumannBCs){
      ...
      currentTime_cp=delT*(currentIncrement_cp+1);
			...
			if (currentTime_cp>userInputs_cp.tabularTimeNeumannBCs[timeCounter_Neumann]){
