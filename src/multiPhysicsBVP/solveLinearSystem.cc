...
void MultiPhysicsBVP<dim,degree>::solveLinearSystem(ConstraintMatrix& constraintmatrix, matrixType_cp& A, vectorType_cp& b, vectorType_cp& x, vectorType_cp& xGhosts, vectorType_cp& dxGhosts){
#else
void MultiPhysicsBVP<dim,degree>::solveLinearSystem(AffineConstraints<double>& constraintmatrix, matrixType_cp& A, vectorType_cp& b, vectorType_cp& x, vectorType_cp& xGhosts, vectorType_cp& dxGhosts){
#endif
...
template <int dim, int degree>
#if ((DEAL_II_VERSION_MAJOR < 9)||((DEAL_II_VERSION_MINOR < 1)&&(DEAL_II_VERSION_MAJOR==9)))
void MultiPhysicsBVP<dim,degree>::solveLinearSystem2(ConstraintMatrix& constraintmatrix, matrixType_cp& A, vectorType_cp& b, vectorType_cp& x, vectorType_cp& xGhosts, vectorType_cp& dxGhosts){
#else
void MultiPhysicsBVP<dim,degree>::solveLinearSystem2(AffineConstraints<double>& constraintmatrix, matrixType_cp& A, vectorType_cp& b, vectorType_cp& x, vectorType_cp& xGhosts, vectorType_cp& dxGhosts){
#endif
