...
void MultiPhysicsBVP<dim,degree>::setPeriodicity_cp(){
...
///Here, we assumed that in the face constraints lines, we always start with FXP, FYP, or FZP.
  GridTools::collect_periodic_faces(triangulation_cp, /*b_id1*/ 1, /*b_id2*/ 0, /*direction*/ 0, periodicity_vector);
  GridTools::collect_periodic_faces(triangulation_cp, /*b_id1*/ 3, /*b_id2*/ 2, /*direction*/ 1, periodicity_vector);
  GridTools::collect_periodic_faces(triangulation_cp, /*b_id1*/ 5, /*b_id2*/ 4, /*direction*/ 2, periodicity_vector);


  triangulation_cp.add_periodicity(periodicity_vector);
  pcout << "periodic facepairs: " << periodicity_vector.size() << std::endl;
}

template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::setPeriodicityConstraintsInit(){
...
//vertices_DOFs: This index set has the global dofs for vertices.
  ...
  periodicBCsInput=userInputs_cp.periodicBCsInput;
  periodicBCsInput2_Orig=userInputs_cp.periodicBCsInput2;
  totalNumVerticesDOFs=24;
  totalNumEachEdgesNodes=userInputs_cp.subdivisions[1]-1;
...
//we want to separatethe Vertices and Edges from the faces.
  ...
  for (const auto &cell : triangulation_cp.cell_iterators()){

    for (unsigned int v = 0; v < GeometryInfo<dim>::vertices_per_cell; ++v)
    {
      vertexNode=cell->vertex(v);
      if ((((vertexNode[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))||(vertexNode[0] <= externalMeshParameterBCs(0)))&&
      ((vertexNode[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))||(vertexNode[1] <= externalMeshParameterBCs(1))))||
      (((vertexNode[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))||(vertexNode[0] <= externalMeshParameterBCs(0)))&&
      ((vertexNode[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))||(vertexNode[2] <= externalMeshParameterBCs(2))))||
      (((vertexNode[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))||(vertexNode[2] <= externalMeshParameterBCs(2)))&&
      ((vertexNode[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))||(vertexNode[1] <= externalMeshParameterBCs(1))))){
...
//(DOFs on Edeges are also defined here which will be used later)
  ...
  //It is important to know that it is assumed here that the sample is a cuboid with x->[0,userInputs_cp.span[0]]
  //y->[0,userInputs_cp.span[1]], and z->[0,userInputs_cp.span[2]].
        ...
        if (cell->face(faceID)->at_boundary()){
          ...
          for (unsigned int i=0; i<dofs_per_cell; ++i) {
            if (fe_face_values.shape_value(i, 0)!=0){
              ...
              if ((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node[1] <= externalMeshParameterBCs(1))&&(node[2] <= externalMeshParameterBCs(2))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node[0] <= externalMeshParameterBCs(0))&&(node[2] <= externalMeshParameterBCs(2))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))&&(node[0] <= externalMeshParameterBCs(0))&&(node[1] <= externalMeshParameterBCs(1))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node[2] <= externalMeshParameterBCs(2))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))&&(node[1] <= externalMeshParameterBCs(1))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))&&(node[0] <= externalMeshParameterBCs(0))){
                flagVertices=1;
                if (dof==0){
              ...
              if ((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))){
                flagVertices=1;
                if (dof==0){
              ...
              if (flagVertices==0){
                if ((((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))||(node[0] <= externalMeshParameterBCs(0)))&&
                ((node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))||(node[1] <= externalMeshParameterBCs(1))))||
                (((node[0] >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))||(node[0] <= externalMeshParameterBCs(0)))&&
                ((node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))||(node[2] <= externalMeshParameterBCs(2))))||
                (((node[2] >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))||(node[2] <= externalMeshParameterBCs(2)))&&
                ((node[1] >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))||(node[1] <= externalMeshParameterBCs(1))))){
                  if (dof==0){
...
//Here, we find the dof0 belong to the nodes of each EX000,EX001,.....
  for(unsigned int i = 0; i < (totalNumEachEdgesNodes*12); i++){
    ...
    if ((node1 <= externalMeshParameterBCs(1))&&(node2 >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))){
      EX001.push_back(std::make_pair(node0,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node1 >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node2 <= externalMeshParameterBCs(2))){
      EX010.push_back(std::make_pair(node0,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node1 >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))&&(node2 >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))){
    ...
    if ((node0 <= externalMeshParameterBCs(0))&&(node2 >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))){
      EY001.push_back(std::make_pair(node1,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node0 >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node2 <= externalMeshParameterBCs(2))){
      EY100.push_back(std::make_pair(node1,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node0 >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node2 >= (userInputs_cp.span[2]-externalMeshParameterBCs(2)))){
    ...
    if ((node0 <= externalMeshParameterBCs(0))&&(node1 >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))){
      EZ010.push_back(std::make_pair(node2,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node0 >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node1 <= externalMeshParameterBCs(1))){
      EZ100.push_back(std::make_pair(node2,global_Edges_DOFs_Vector_Array[0][i]));
    }
    if ((node0 >= (userInputs_cp.span[0]-externalMeshParameterBCs(0)))&&(node1 >= (userInputs_cp.span[1]-externalMeshParameterBCs(1)))){
...
void MultiPhysicsBVP<dim,degree>::setNodeConstraints(ConstraintMatrix& constraintmatrix){
#else
void MultiPhysicsBVP<dim,degree>::setNodeConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim, int degree>
#if ((DEAL_II_VERSION_MAJOR < 9)||((DEAL_II_VERSION_MINOR < 1)&&(DEAL_II_VERSION_MAJOR==9)))
void MultiPhysicsBVP<dim,degree>::setEdgeConstraints(ConstraintMatrix& constraintmatrix){
#else
void MultiPhysicsBVP<dim,degree>::setEdgeConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim, int degree>
#if ((DEAL_II_VERSION_MAJOR < 9)||((DEAL_II_VERSION_MINOR < 1)&&(DEAL_II_VERSION_MAJOR==9)))
void MultiPhysicsBVP<dim,degree>::setFaceConstraints(ConstraintMatrix& constraintmatrix){
#else
void MultiPhysicsBVP<dim,degree>::setFaceConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::setPeriodicityConstraintsInc0(){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::setPeriodicityConstraintsInc0Neg(){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::setPeriodicityConstraintsIncNot0(){
...
template <int dim, int degree>
void MultiPhysicsBVP<dim,degree>::setPeriodicityConstraints_cp(){
  constraints.clear();
  ...
  if (currentIteration==0){
    if(userInputs_cp.enableTabularPeriodicBCs){
      ...
      currentTime_cp=delT*(currentIncrement_cp+1)-delT/1000;
      if (currentIncrement_cp==0){
        timeCounter=1;
      }
      if (currentTime_cp>userInputs_cp.tabularPeriodicTimeInput[0][timeCounter]){
        timeCounter=timeCounter+1;
      }
      ////////Loading case
      if (userInputs_cp.tabularPeriodicCoef[0][timeCounter-1]==1){
        constraints.copy_from(constraints_PBCs_Inc0);
      }
      ////////Unloading case
      else if (userInputs_cp.tabularPeriodicCoef[0][timeCounter-1]==-1) {
        constraints.copy_from(constraints_PBCs_Inc0Neg);
      }
      ////////Neutral= No Loading or Unloading
      else if (userInputs_cp.tabularPeriodicCoef[0][timeCounter-1]==0){
