...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicity_cp(){
...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicityConstraintsInit(){
...
void multiPhysicsBVP<dim>::setNodeConstraints(ConstraintMatrix& constraintmatrix){
#else
void multiPhysicsBVP<dim>::setNodeConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim>
#if ((DEAL_II_VERSION_MAJOR < 9)||((DEAL_II_VERSION_MINOR < 1)&&(DEAL_II_VERSION_MAJOR==9)))
void multiPhysicsBVP<dim>::setEdgeConstraints(ConstraintMatrix& constraintmatrix){
#else
void multiPhysicsBVP<dim>::setEdgeConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim>
#if ((DEAL_II_VERSION_MAJOR < 9)||((DEAL_II_VERSION_MINOR < 1)&&(DEAL_II_VERSION_MAJOR==9)))
void multiPhysicsBVP<dim>::setFaceConstraints(ConstraintMatrix& constraintmatrix){
#else
void multiPhysicsBVP<dim>::setFaceConstraints(AffineConstraints<double>& constraintmatrix){
#endif
...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicityConstraintsInc0(){
...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicityConstraintsInc0Neg(){
...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicityConstraintsIncNot0(){
...
template <int dim>
void multiPhysicsBVP<dim>::setPeriodicityConstraints_cp(){
  constraints.clear();
