...
//template <int dim>
//void multiPhysicsBVP<dim>::setIndentation(){
...
//}
template <int dim>
void multiPhysicsBVP<dim>::meshRefineIndentation() {
...
template <int dim>
void multiPhysicsBVP<dim>::updateIndentPos() {
    double pos;
...
template <int dim>
void multiPhysicsBVP<dim>::displaceNode(const Point<dim> & p, const Point<dim> & u)
{
...
//INDENTATION
template <int dim>
bool multiPhysicsBVP<dim>::flagActiveSet(const Point<dim> & p)
{
    double dist2;
    double dist1;
    double tmp;
...
template <int dim>
bool multiPhysicsBVP<dim>::flagActiveSetLambda(const Point<dim> & p, double & criterion)
{
    double dist2;
    double dist1;
    double tmp;
...
template <int dim>
bool multiPhysicsBVP<dim>::flagActiveSetLambda2(const Point<dim> & p, double & criterion)
{
    double dist2;
    double dist1;
    double tmp;
...
template <int dim>
double multiPhysicsBVP<dim>::Obstacle(const Point<dim> & p, const unsigned int & component, const std::vector<double> & ind)
{
...
template <int dim>
void multiPhysicsBVP<dim>::assemble_mass_matrix_diagonal()
{
...
/*template <int dim>
void multiPhysicsBVP<dim>::updateActiveSet(){
...
//INDENTATION
template <int dim>
void multiPhysicsBVP<dim>::setIndentation(const Point<dim>& node,
...
template <int dim>
void multiPhysicsBVP<dim>::setIndentation2(const Point<dim>& node,
                                      const unsigned int dof,
...
template <int dim>
void multiPhysicsBVP<dim>::setActiveSet(){
    std::vector<bool> dof_touched(dofHandler.n_dofs(), false);
...
template <int dim>
void multiPhysicsBVP<dim>::measureIndentationLoad(){
...
template <int dim>
void multiPhysicsBVP<dim>::setActiveSet2(){
    vectorType_cp lambda2(locally_owned_dofs,locally_relevant_ghost_dofs,mpi_communicator);
    std::vector<bool> dof_touched(dofHandler.n_dofs(), false);
...
template <int dim>
void multiPhysicsBVP<dim>::setFrozenSet(){
    vectorType_cp lambda2(locally_owned_dofs,locally_relevant_ghost_dofs,mpi_communicator);
    std::vector<bool> dof_touched(dofHandler.n_dofs(), false);
    bool active_set_empty = true;
    const unsigned int   dofs_per_cell   = FE.dofs_per_cell;
...
template <int dim>
void multiPhysicsBVP<dim>::setIndentationConstraints(){
