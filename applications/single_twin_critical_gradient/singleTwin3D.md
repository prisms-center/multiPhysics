...
We employ a Phase-Field / Crystal Plasticity models coupling strategy similar to the one introduced by by Liu et al. in Ref. [1]. 
...
&=\int_{\Omega}\omega r_\phi dV + \int_{\Omega}\nabla \omega\cdot \boldsymbol{r}_{\phi x} ~dV,
\end{align}
$$
...
$$
\begin{align}
\boldsymbol{r}_{\phi x} = -\Delta t M \boldsymbol{\kappa}\nabla \phi^{n}
\end{align}
$$
