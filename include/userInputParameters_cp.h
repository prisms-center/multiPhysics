...
#ifndef INCLUDE_USERINPUTPARAMETERS_CP_H_
#define INCLUDE_USERINPUTPARAMETERS_CP_H_

#include "dealIIheaders.h"

class userInputParameters_cp
{

public:

  userInputParameters_cp(std::string input_file_name, dealii::ParameterHandler & parameter_handler);
