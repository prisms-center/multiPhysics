...
#ifndef INCLUDE_USERINPUTPARAMETERS_PF_H_
#define INCLUDE_USERINPUTPARAMETERS_PF_H_
...
template <int dim>
class userInputParameters_pf
{

public:
	// Method to read the input parameters from a file and load them into the class member variables
	userInputParameters_pf(inputFileReader & input_file_reader, dealii::ParameterHandler & parameter_handler, variableAttributeLoader variable_attributes);
...
#endif /* INCLUDE_USERINPUTPARAMETERS_PF_H_ */
